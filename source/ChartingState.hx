...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	private function addNote(?n:Note):Void
	{
		...
		var noteSus = 0;
		var noteSussyBallsAkaType = false;

		if (FlxG.keys.pressed.ALT)
			noteSussyBallsAkaType = true;
		...
		if (n == null)
		{
			var note:Note = new Note(noteStrum, noteData % 4, null, false, true, TimingStruct.getBeatFromTime(noteStrum), noteSussyBallsAkaType);
		...
		{
			var note:Note = new Note(n.strumTime, n.noteData % 4, null, false, true, n.isAlt, TimingStruct.getBeatFromTime(n.strumTime), n.notePoison);
